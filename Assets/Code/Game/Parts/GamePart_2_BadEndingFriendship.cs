...
{
    public class GamePart_2_BadEndingFriendship : GamePart, IPartTickListener, IRestarable
    {
        public override GamePartName GamePartName => GamePartName.Part_2__bad_ending_friendship;
        [Header("Components")]
