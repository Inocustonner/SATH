...
{
    public class GamePart_2_BadEndingDisownage : GamePart,IGameInitListener, IPartTickListener, IRestarable
    {
        public override GamePartName GamePartName => GamePartName.Part_2__bad_ending_disownage;
        [Header("Components")]
