...
namespace Code.Infrastructure.Services
{
    public class GameConditionService : IService, IGameInitListener
    {
        ...
        public void GameInit()
        {
         ...
         this.Log($"{_conditionObservers.Length}",Color.yellow);
        ...
        {
                  this.Log($"{condition} -> null = {_conditions[condition] == null } is true = {_conditions[condition]?.IsTrue}  == {_conditions[condition] == null || _conditions[condition].IsTrue}", Color.yellow);
